...
def initialize_vector_db(docs):
    ...
    # Manage the number of collections in memory (limit to the last 20)
...
def get_conversational_rag_chain(llm):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ...
        You will have some context to help with your answers, but not always will it be completely related or helpful.
        You can also use your knowledge to assist in answering the user's queries.\n
        {context}"""),
        MessagesPlaceholder(variable_name="messages"),
        ("user", "{input}"),
    ])
